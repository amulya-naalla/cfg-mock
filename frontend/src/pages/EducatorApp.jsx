...
import NewAssessmentForm from './NewAssessmentForm.jsx';
  ...
  return (
    <div className="app">
      ...
      <header className="app-header">
        <Link to="/" className="back-link" title="Back to role selection" style={{ marginRight: 16 }}>
          ←
        </Link>
      ...
      <nav className="app-nav">
        <NavLink to="/educator/dashboard" end className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>Dashboard</NavLink>
        <NavLink to="/educator/content" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>Content</NavLink>
      </nav>
